...
class RecipeTest {
    ...
    void testEquals_Equals() {
        Recipe recipe1 = new Recipe("Test Recipe", "Test Description");
    ...
    void testEquals_NotEquals_WrongName() {
        Recipe recipe1 = new Recipe("Test Recipe 1", "Test Description");
        Recipe recipe2 = new Recipe("Test Recipe 2", "Test Description");
    ...
    void testEquals_NotEquals_WrongDescription() {
        ...
        Recipe recipe2 = new Recipe("Test Recipe 1", "Test Description 2");
    ...
    void testHashCode_NameNull() {
        Recipe recipe1 = new Recipe("Test Recipe", "Test Description 1");
        Recipe recipe2 = new Recipe(null, "Test Description 2");
    ...
    void testHashCode_DescriptionNull() {
        Recipe recipe1 = new Recipe("Test Recipe", "Test Description 1");
        Recipe recipe2 = new Recipe("Test Recipe", null);
    ...
    void testToString() {
        ...
        String expectedToString = "Recipe{id=" + recipe.id + ", name='" + recipe.name + "', description='" + recipe.description + "'}";
    ...
    void testUpdate_NameNull() {
        Recipe recipe1 = new Recipe("Test Recipe", "Test Description");
        Recipe recipe2 = new Recipe(null, "Test Description");
